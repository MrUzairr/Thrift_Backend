...
//       const { totalAmount, userId, product } = req.body;
...
//           name: "Product",
//           // images: [
//           //   `http://localhost:3005/images/${item.Images}`,
//           // ],
//         },
//         price: item.price * 100,
//       }},
//       mode: "payment",
//       success_url: `http://localhost:3000/?session_id={CHECKOUT_SESSION_ID}&userId=${userId}&cartItems=${encodeURIComponent(
...
//     }
  ...
  // checkout().then((url) =>res.redirect(url)).catch((err) => console.log(err));
